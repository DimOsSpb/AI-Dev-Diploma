---
id: k8s-00062
title: Генерация справочной документации API Kubernetes
product: kubernetes
...
Далее в этом разделе рассматривается генерация [справочной документации по API Kubernetes](/docs/reference/generated/kubernetes-api//).
