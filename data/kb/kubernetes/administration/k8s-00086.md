---
id: k8s-00086
title: Управление ресурсами и конфигурациями Kubernetes
product: kubernetes
...
Предположим, что существует директория `project/k8s/development`, в которой хранятся все , необходимые для dev-окружения, организованные по типу ресурсов:
...
Например, разные приложения могут использовать разные значения для лейбла `app`, а в случае многоуровневого приложения вроде [гостевой книги](https://github.com/kubernetes/examples/tree/master/web/guestbook/) лейблы могут указывать на соответствующий уровень. Например, у фронтенда могут быть следующие лейблы:
