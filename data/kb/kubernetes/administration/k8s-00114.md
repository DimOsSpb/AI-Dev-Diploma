---
id: k8s-00114
title: Minikube: установка и управление локальным кластером
product: kubernetes
...
Вы можете указать используемую версию Kubernetes в Minikube, добавив параметр `--kubernetes-version` в команду `minikube start`. Например, чтобы запустить Minikube из-под версии , вам нужно выполнить следующую команду:
...
* none (Запускает компоненты Kubernetes на хосте, а не на виртуальной машине. Использование этого драйвера требует использование Linux и установленного .)
