---
id: k8s-00015
title: Настройка запросов и лимитов CPU для контейнеров
product: kubernetes
category: workloads
tags:
  - kubernetes
...
Если вы используете , выполните следующую команду,
...
Создадим , чтобы создаваемые в этом упражнении
...
кластера могут использовать [LimitRange](/docs/reference/generated/kubernetes-api//#limitrange-v1-core/),
