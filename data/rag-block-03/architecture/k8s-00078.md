---
id: k8s-00078
title: Контейнерное окружение Kubernetes
product: kubernetes
...
Сервисы получают выделенные IP-адреса и доступны для контейнера через DNS, если включен [аддон DNS](https://releases.k8s.io/v/cluster/addons/dns/). 
